    ...
    <body>
        ...
        if (isset($_POST['szukaj'])) {
            ...
            $wynik = $polaczenie->query("SELECT * FROM zarejestrowani RIGHT JOIN ogloszenia ON ogloszenia.idzarejestrowanego=zarejestrowani.id "
                    . "LEFT JOIN zdjecia ON ogloszenia.idogloszenia=zdjecia.idogloszenia  WHERE (tytul LIKE '%$szukaj%'OR tresc LIKE '%$szukaj%') ORDER BY dataogloszenia DESC")
